                    ...
                    <form method="POST" action="{{ route('consultas.store') }}"
                        ...
                        <div>
                            ...
                            <input type="text" name="especialidade" id="especialidade"
                                ...
                                required aria-describedby="especialidade-error">
                            @error('especialidade')
                                <p class="mt-1 text-xs sm:text-sm text-red-600" id="especialidade-error">{{ $message }}
                                </p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="datetime-local" name="data_hora" id="data_hora" value="{{ old('data_hora') }}"
                                class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm sm:text-base py-2.5 sm:py-3"
                                required aria-describedby="data_hora-error">
                            @error('data_hora')
                        ...
                        <div>
                            ...
                            <input type="text" name="local" id="local" value="{{ old('local') }}"
                                class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm sm:text-base py-2.5 sm:py-3"
                                required aria-describedby="local-error">
                            @error('local')
                        ...
                        <div>
                            ...
                            <textarea name="observacoes" id="observacoes" rows="4"
                                class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm sm:text-base py-2.5 sm:py-3">{{ old('observacoes') }}</textarea>
                            @error('observacoes')
                                <p class="mt-1 text-xs sm:text-sm text-red-600" id="observacoes-error">{{ $message }}
                                </p>
                            @enderror
                        </div>
